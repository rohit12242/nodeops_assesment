...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface GovernanceRootPublisherInterface extends Interface {
    getFunction(nameOrSignature: "WAD" | "_adminRemoveProposal" | "_adminSetMetadata" | "getProposalCore" | "isPublished" | "owner" | "proposals" | "publishProposal" | "renounceOwnership" | "transferOwnership" | "updateMetadata"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "OwnershipTransferred" | "ProposalCreated" | "ProposalMetadataUpdated"): EventFragment;

    encodeFunctionData(functionFragment: 'WAD', values?: undefined): string;
encodeFunctionData(functionFragment: '_adminRemoveProposal', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: '_adminSetMetadata', values: [BigNumberish, string]): string;
...
decodeFunctionResult(functionFragment: '_adminRemoveProposal', data: BytesLike): Result;
decodeFunctionResult(functionFragment: '_adminSetMetadata', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'updateMetadata', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    _adminRemoveProposal: TypedContractMethod<
    ...
    _adminSetMetadata: TypedContractMethod<
    ...
    getFunction(nameOrSignature: 'WAD'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: '_adminRemoveProposal'): TypedContractMethod<
      [proposalId: BigNumberish, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: '_adminSetMetadata'): TypedContractMethod<
      [proposalId: BigNumberish, metadata: string, ],
      [void],
      'nonpayable'
    >;
